const translations = {
  ...
  en: {
    ...
    ia_lead: '<span class="ia-lead-brand">tuko AI</span> builds your <span class="ia-lead-key">group buying</span> campaigns <em>for you</em>—it reads your store and market, then decides <span class="ia-lead-key">what</span> to group, at <span class="ia-lead-key">what price</span>, and <span class="ia-lead-key">when</span>.',
    ...
    ia_panel_analyzing: 'Reading your store…',
    ia_panel_ready: 'Campaign ready',
    ia_panel_signals_title: 'Reading your store',
    ia_panel_s1: 'Market',
    ...
    ia_panel_s6: 'Sales',
    ia_panel_proposal: 'Campaign ready',
    ia_panel_recommended: 'Recommended',
    ia_panel_product: 'Vitamin C Serum 30ml',
    ia_panel_insight: 'Strong fit for your store right now',
    ia_panel_price: '€18.90',
    ...
    ia_panel_discount_sub: 'Unlocks from 5 people',
    ia_panel_preparing: 'Building your campaign…',
    ...
    ia_signals_sub: 'tuko AI crosses your store data with market signals to choose the product, the price ladder, and the moment to launch.',
    ...
    ia_sig2_text: 'What they launch, at what discounts, and where there is room for you to win.',
    ia_sig3_title: 'Your calendar',
    ia_sig3_text: 'Key dates and traffic peaks when a group can fill itself.',
    ia_sig4_title: 'Your location',
    ia_sig4_text: 'Where your buyers are—so groups form by area and shipping stays efficient.',
    ia_sig5_title: 'Your products',
    ia_sig5_text: 'Margins, idle stock, and which items can carry a volume discount.',
    ia_sig6_title: 'Your sales',
    ia_sig6_text: 'What sells together, how often, and at what price it actually converts.',
    ia_flow_eyebrow: 'How it will work',
    ia_flow_title: 'From zero to <em>campaign</em>—without the research grind.',
    ia_flow_sub: 'Today, launching a group buy means picking products, discounts, and minimums by hand. tuko AI does that work for you.',
    ia_step1_title: 'Connect',
    ia_step1_meta: 'Shopify · no forms',
    ia_step1_text: 'Install Tuko on Shopify. tuko AI reads your catalogue and sales history—nothing to fill in.',
    ia_step2_title: 'Propose',
    ia_step2_meta: 'Campaign ready',
    ia_step2_text: 'You get a ready-made campaign: which product, which discounts, how many people, and how long it runs.',
    ia_step3_title: 'Learn',
    ia_step3_meta: 'Gets sharper over time',
    ia_step3_text: 'Every completed group makes the next one better—tuned to how your buyers actually behave.',
    ia_final_title: 'Be among the first to try it.',
    ia_final_sub: 'tuko AI is in development. Leave your email and we will tell you the moment early access opens.',
    ...
    ia_form_intro: 'We will email you when early access opens. No spam.',
    ia_form_submit: 'Join the waitlist',
    ia_soon_tag: 'Soon',
    ia_soon_text: 'It will also suggest which creators to work with—and where to grow next.',
    ...
    hero_title: 'Turn your traffic<br>into <em>group sales</em>',
    hero_subtitle: 'Tuko lets shoppers buy together and unlock better prices—right inside your Shopify store',
    hero_cta: 'Install Tuko',
    hero_official: 'Verified app on <i>Shopify</i>',
    hero_stat1_lab: 'Active stores',
    hero_stat2_lab: 'Sales driven for stores',
    ...
    /* PROBLEM */
    problem_badge: 'Sound familiar?',
    problem_title: 'Ecommerce needs<br>a better growth engine',
    problem_sub: 'Most brands fight with the same playbook—while acquisition costs climb and margins get thinner.',
    card1_title: 'Paid traffic keeps getting pricier',
    card1_text: 'Ad costs rise every year while returns fall, so scaling sales without burning cash gets harder.',
    card2_title: 'Stock that won’t move',
    card2_text: 'Slow sellers and aging inventory tie up cash and force uncomfortable discount decisions.',
    card3_title: 'Discounts that erase margin',
    card3_text: 'Blanket promotions cut too deep and still rarely create the volume you actually need.',

    /* HOW IT WORKS */
    how_badge: 'The fix',
    how_title: 'Meet <span class="how-title-underline">group buying</span>',
    how_sub: 'Tuko turns any product into a group buy built into your storefront—not bolted on as an afterthought.',
    how_step1: 'Turn Tuko on for any product you choose.',
    how_step2: 'Shoppers can buy now—or join a group for a better price.',
    how_step3: 'Tuko handles timing, progress, and participants.',
    how_step4: 'When the group fills, everyone pays the unlocked price.',

    /* HOW IT WORKS — STEPS */
    step1_title: 'Turn Tuko on',
    step1_desc: 'Enable group buying on any product in your store.',
    step2_title: 'Shoppers join the group',
    step2_desc: 'Buyers invite others to unlock the next discount tier.',
    step3_title: 'The group fills',
    step3_desc: 'When the target is hit, everyone gets the better price.',
    step4_title: 'What changes for your store',
    step4_desc: 'More sales, faster inventory turns, and growth driven by your buyers.',
    ...
    /* BENEFITS */
    benefits_badge: 'Why brands choose Tuko',
    benefits_title: 'Grow through your buyers—<br>not bigger ad budgets',
    benefits_sub: 'More sales, healthier inventory, and promotions you stay in control of.',
    ben1_title: 'More sales from the traffic you already have',
    ben1_text: 'Turn today’s visitors into completed orders—without raising spend or leaning harder on ads.',
    ben2_title: 'Move slow stock faster',
    ben2_text: 'Launch group buys on products that sit still and free up cash tied up in inventory.',
    ben3_title: 'Protect your margins',
    ben3_text: 'Set tiered discounts that unlock only when targets are hit—so you never give margin away for free.',
    ben4_title: 'Built-in word of mouth',
    ben4_text: 'Every buyer has a reason to share the group, so reach grows from real people—not more media spend.',
    ben5_title: 'Live in minutes',
    ben5_text: 'Install on Shopify and launch a campaign quickly—no heavyweight technical project.',
    ben6_title: 'Operations you can trust',
    ben6_text: 'Payments, validations, and settlement run automatically so campaigns stay smooth for you and your buyers.',
