const translations = {
  es: {
    ...
    ia_panel_generated: 'Generado por tuko IA',
    ia_signals_eyebrow: 'Qué analiza',
    ia_signals_title: 'Seis señales. <em>Una campaña lista.</em>',
    ia_signals_sub: 'tuko IA cruza los datos de tu tienda con los de tu mercado para decidir qué producto agrupar, a qué precio y en qué momento.',
    ...
    ia_flow_sub: 'Hoy montar una compra colectiva exige elegir producto, descuentos y mínimos a mano. tuko IA lo resuelve entero.',
    ia_step1_title: 'Conecta',
    ia_step1_meta: 'Shopify · sin formularios',
    ia_step1_text: 'Instalas Tuko en tu Shopify. tuko IA lee tu catálogo y tu histórico de ventas. No rellenas nada.',
    ...
    ia_final_sub: 'tuko IA está en desarrollo. Déjanos tu correo y te avisamos en cuanto abramos el acceso anticipado.',
    ia_final_btn: 'Quiero acceso anticipado',
    ia_form_title: 'Únete a la lista de espera de <span class="cta-brand">tuko IA<span class="cta-brand-glint" aria-hidden="true"></span></span>',
  ...
  en: {
    ...
    ia_panel_generated: 'Generated by tuko IA',
    ia_signals_eyebrow: 'What it reads',
    ia_signals_title: 'Six signals. <em>One campaign, ready.</em>',
    ia_signals_sub: 'tuko IA combines your store data with your market data to decide which product to group, at what price and when.',
    ...
    ia_flow_sub: 'Setting up a group buy today means choosing product, discounts and minimums by hand. tuko IA handles all of it.',
    ia_step1_title: 'Connect',
    ia_step1_meta: 'Shopify · no forms',
    ia_step1_text: 'You install Tuko on your Shopify. tuko IA reads your catalogue and sales history. Nothing to fill in.',
    ...
    ia_final_sub: 'tuko IA is in development. Leave your email and we will tell you as soon as early access opens.',
    ia_final_btn: 'I want early access',
    ia_form_title: 'Join the <span class="cta-brand">tuko IA<span class="cta-brand-glint" aria-hidden="true"></span></span> waitlist',
