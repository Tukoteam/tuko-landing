const translations = {
  es: {
    ...
    fcta_sub: 'Instalar es gratis. El plan Free no tiene cuota: 4,2 % de lo que vendas con Tuko, con tope de 500 €/mes.',
    fcta_btn: 'Instalar gratis en Shopify',
    fcta_trust1: '5,0 en Shopify App Store',
    fcta_trust2: 'Plan Free sin cuota',
  ...
  en: {
    ...
    ia_sig3_text: 'Key dates and traffic peaks when a campaign can fill itself.',
    ia_sig4_title: 'Your location',
    ia_sig4_text: 'Where your buyers are—so orders group by area and shipping stays efficient.',
    ...
    ia_flow_sub: 'Today, launching a campaign means picking products, discounts, and minimums by hand. tuko AI does that work for you.',
    ...
    ia_step2_text: 'You get a ready-made campaign: which product, which discounts, how many units, and how long it runs.',
    ia_step3_title: 'Learn',
    ia_step3_meta: 'Gets sharper over time',
    ia_step3_text: 'Every completed campaign makes the next one better—tuned to how your buyers actually behave.',
    ...
    fcta_sub: 'Install is free. The Free plan has no subscription: 4.2% of what you sell with Tuko, capped at €500/mo.',
    fcta_btn: 'Install free on Shopify',
    fcta_trust1: '5.0 on the Shopify App Store',
    fcta_trust2: 'Free plan, no subscription',
